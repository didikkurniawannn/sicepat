...
<div class="grid grid-cols-2 md:grid-cols-5 gap-3 mb-6">
  ...
  <div class="bg-white rounded shadow p-4 border-2 border-red-400"><p class="text-xs text-slate-500">⚠ H-7 (butuh persiapan PPTK)</p><p class="text-2xl font-bold text-red-600">{{ $h7 }}</p></div>
</div>
